...
For years, video games have garnered the attention of people worldwide, providing a unique environment for entertainment, story adventure, knowledge acquirement, and etc. Arising with the popularity of video games is a critical question as how to keep player engaged in playing games.  

In video games, players also face a variety of choices of in-game elements, such as which characters to play as, which items to equip with, or which opponents to play against. Controlling what in-game elements to present to them could influence their choices of in-game elements, the way they play, competence they perceive, and eventually their engagement. 

In this thesis I propose to use recommendation system techniques for dedicatedly presenting players in-game elements in order to influence player competence and improve consequent player engagement. In video games, players face a variety of choices of in-game elements, such as items, characters, and opponents, the choices of which would influence how they interact with a game and how they perceive in-game challenge and competence, and could consequently impact player engagement, as suggested by an extensive body of research. My research is further delimited within the pre-match stage of match-based video games, when in-game elements determined before a match starts could already have an impact on in-game competence. Within these boundaries, I propose to study a few related questions.

First, I study recommendation system techniques for solely improving player competence, in both one-vs-one and team-vs-team settings. These techniques are fundamental to competence manipulation however are considered as \textit{indirect} ways to influence player engagement because they could only be useful when integrated with other systems for deciding when to deliver these recommendations. Along these lines, I investigate techniques for effectively and efficiently suggesting winning-effective in-game elements, which are useful for aiding players make wise decisions to increase their chances of victory. 

To this end, I propose \textit{Q-DeckRec} for recommending winning-effective decks, a set of cards seen as the starting items, in one-vs-one Collectible Card Games (CCGs). Q-DeckRec deals with the challenge of using minimal computational resources to identify a winning-effective deck against an opponent stereotype from a large number of deck candidates. Based on simulations operated by AI bots, Q-DeckRec, after a training phase, is able to recommend equally or more winning-effective decks with much less computational resource in terms of CPU time compared to other methods. 

I also propose \textit{DraftArtist} for recommending winning-effective characters in Multi-player Online Battle Arena (MOBA) games, which are played team-vs-team. The challenge here is that other players' character selection strategies bring a large number of possibilities and uncertainty and need to be taken into accounts; a desirable character recommendation system should predict what other players will select and efficiently search for characters which synergize the teammates' and counter the opponents'. Using a match outcome prediction model trained on real data, we find that teams following our recommendation algorithm for character selection have higher predicted win rates against teams constructed by other character selection strategies.

Next, I study in-game element recommendation systems which operationalize player competence for \textit{directly} improving player engagement. I propose to study opponent recommendation, also known as matchmaking, a special case in which the goal is to connect multiple players to form online matches and players themselves are the subject of recommendations. I propose \textit{Engagement-Optimized Matchmaking} (EOMM) in which projected match outcomes between paired players would optimize all involved players' engagement measured by churn risks (i.e., quiting probabilities). We build a player behavior simulation system based on real data, showing significant improvement in enhancing population-wise player engagement by EOMM against other matchmaking methods.
